...
sample_md[, condition := factor(condition, levels = c("BM", "PB"))]
sample_md[, batch := factor(batch)]
colnames(sample_md)
...
colname_fs <- panel_md$antigen
colname_fs[6:15] <- paste(panel_md$antigen[6:15], panel_md$fluorochrome[6:15], sep = " ")
